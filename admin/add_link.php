<?php
	...
	if(isset($_POST['submit'])){
		...
		if($name == '' && $location == ''){
			echo "Please, enter a link and its location";
		}
		else{			
			$query = "INSERT INTO links (name, href)
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-12 blog-main">
							<br/>
							<h2>Add a new link</h2><hr>
							<form action="add_link.php" method="post">
								<div class="form-group">
									<label>Link Name:</label>
									<input type="text" name="name" class="form-control" placeholder="Add a new link">
								</div>		
								<div class="form-group">
									<label>Link Location:</label>
									<input type="text" name="location" class="form-control" placeholder="Add the address">
								</div>					
